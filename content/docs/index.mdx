...
[Employment taxes are indirect taxes by definition. We can eliminate 160 million income tax filers (here)](/docs/ab-policy)
...
[The Debates in the Several State Conventions vol. 4, 1788](https://oll.libertyfund.org/titles/elliot-the-debates-in-the-several-state-conventions-vol-4), Mr. SEDGWICK said, 
...
retirements, and taxes among other costs. Using economics, the cost of the employees wage income taxes are funded only by the employers payroll; and can never be otherwise.
> A direct tax upon the wages of labour, therefore, though the labourer might perhaps pay it out of his hand, could not be said to be even advanced by him; -- Adam Smith, Wealth of Nations
 
Could be, that if the income taxes on employee wages were truly an indirect tax, the employer would be collecting any taxes due and relieve the employee of any tax liability.
Here are true cases ofindirect taxes on labor that neither the employee nor employer can adjust funded by employer payrolls:
...
<Cards>
  ...
  <Card title="Learn more about the Indirect Nature of Income Taxes" href="https://direct-taxes.link/docs/ab-policy" />
