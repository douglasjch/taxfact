...
export default function HomePage() {
  return (
    <main className="flex flex-1 flex-col justify-center text-center">
      ...
      <h2 className="mb-8 text-lg font-serif font-bold"> 
        &quot;The great object of the Constitution was, to give Congress a power to lay taxes, adequate to the exigencies of government; but they were to observe...the rule of apportionment, according to the census, when they 
